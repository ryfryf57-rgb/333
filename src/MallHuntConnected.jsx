...
const request = async (path, options = {}) => {
  ...
  try {
    ...
    if (e.name === "TypeError" || e.name === "TimeoutError" || e.name === "AbortError") {
      console.warn("[api] backend unreachable → MOCK mode");
...
// ПРОФИЛЬ
// =========================================================================
const ProfileScreen = ({ user, caughtIds, points, onLogout, onShop, onLeaderboard, purchasedIds }) => {
